  ...
  methods: {
    async onSubmit() {
      try {
        ...
        this.$store.commit('setUser', data.user); // 为了防止刷新页面丢失数据，将数据持久化存储到cookie
